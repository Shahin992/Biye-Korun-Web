...
import bannerImg from '../../assets/bannerpost.png'
...
const BlogCard = () => {
    return (
        <div>
            <div  className='w-full flex flex-col lg:flex-row mx-[10px] my-4 '>
                <div>
                <div className=' '>
{/* FIRST POST */}
  
<div className='w-[300px]  lg:w-[930px] border-[1px] border-[rgba(0, 0, 0, 0.10)] h-[429px] lg:h-[520px] bg-[#F8F8F8] mt-4 rounded-md mr-2'>

<img src={bannerImg} className=' rounded-lg mt-[20px] h-auto lg:h-[329px] w-[290px] lg:w-[880px] mx-[5px] lg:mx-[20px] '></img>
...
<p className='text-[14px] font-medium text-[#636363] justify-end'>10 minute read</p>
 ...
 {/* second post */}
 <div className='bg-[#F8F8F8] w-[300px]  lg:w-[930px]  border-[1px] border-[rgba(0, 0, 0, 0.10)]  h-[230px] mt-[50px] lg:mt-[30px] rounded-lg mr-2'>
 <div className='flex my-[30px] mx-[10px] '>
     {/* image */}
     <img src={postImg}  className='w-[41px] h-[41px] rounded-full'></img>
     <div className='ml-2'>
        {/* details */}
